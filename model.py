...
mean_iat = 0.067                     # average time between customer demands (months)
demand_sizes = [1, 2, 3, 4]         # possible customer demand sizes
demand_prob = [1/2, 1/4, 1/8, 1/8]  # probability of each demand size
start_inventory = 50.               # units in inventory at simulation start
order_cost_setup = 60.
order_cost_per_item = 5.
backlog_cost_per_item = 4.
...
class InventorySystem:
    ...
    def place_order(self, env, units):
        ...
        lead_time = np.random.uniform(.25, 1.25)
